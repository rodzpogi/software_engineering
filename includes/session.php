...
if (!empty($_SESSION['role'])) {
  ...
  elseif ($_SESSION['role'] === "Admission") {
    ...
    $query_stud = $db->query("SELECT admission_id, image ,username FROM tbl_admission WHERE admission_id = '$admission_id'");
    $row_stud = $query_stud->fetch_array();
    $user_image = $row_stud['image'];
    $user_name = $row_stud['username'];
  ...
  elseif ($_SESSION['role'] === "Osas") {
    $osas_id = $_SESSION['userid'];

    $query_stud = $db->query("SELECT osas_id, image ,username FROM tbl_osas WHERE osas_id = '$osas_id'");
    $row_stud = $query_stud->fetch_array();
    $user_image = $row_stud['image'];
    $user_name = $row_stud['username'];
