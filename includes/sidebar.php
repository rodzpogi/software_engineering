            ...
            <ul class="nav ">
              ...
              <li class="nav-item ">
                <a class="nav-link text-white " href="../../pages/custodian/add.custodian.php">
                  ...
                  <span class="nav-link-text ms-1">Add Custodian</span>
                </a>
              </li>
              ...
              <li class="nav-item ">
                <a class="nav-link text-white " href="../../pages/admission/add-admission.php">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="material-icons opacity-10">person_add</i>
                  </div>
              ...
              <li class="nav-item ">
                <a class="nav-link text-white " href="../../pages/osas/add-osas.php">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="material-icons opacity-10">person_add</i>
                  </div>
                  <span class="nav-link-text ms-1">Add Osas</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="ecommerceExamples">
            <ul class="nav ">
              ...
              <li class="nav-item ">
                <a class="nav-link text-white " href="../osas/osas-lists.php">
                  <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="material-icons">
                      toc
                    </i>
                  </div>
                  <span class="nav-link-text ms-2 ps-1">Osas Lists</span>
                </a>
              </li>
...
<ul class="navbar-nav">
  ...
  <li class="nav-item mt-0">
    <a data-bs-toggle="collapse" href="#ProfileNav" class="nav-link text-white" aria-controls="ProfileNav" role="button" aria-expanded="false">
      <?php 
      $getImg = mysqli_query($db, "SELECT image FROM tbl_admission WHERE admission_id = '$admission_id'");
            while ($row = mysqli_fetch_array($getImg)) {
      if (empty($row['img'])) {
        echo '<img class="avatar" style="height:45px; width:45px;" src="../../assets/img/image.png"/>';
      } else {
  ...
  <?php
  $verify = $db->query("SELECT admission_id FROM tbl_admission WHERE admission_id = $admission_id");
$num = $verify->num_rows;
