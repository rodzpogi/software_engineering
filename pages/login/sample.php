                ...
                <div class="col-md-4">
                    ...
                    if (isset($_POST["email"]) && (!empty($_POST["email"]))) {
                        ...
                        if (!$email) {
                            ...
                            $sel_query = "SELECT * FROM tbl_form WHERE email='" . $email . "'";
                        ...
                        if ($error != "") {
                            ...
                            $mail->SMTPAuth = true;
                            $mail->Username = "sfaclp2021@gmail.com"; // Enter your email here
                            $mail->Password = "03132804_J@son"; //Enter your passwrod here
                            $mail->Port = 587;
                            $mail->IsHTML(true);
                            $mail->From = "sfaclp2021@gmail.com";
                            $mail->FromName = "SFAC- Recover Password";
